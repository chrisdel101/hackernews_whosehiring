...
export default function SearchAppBar({handleChange}: IProps) {
    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" sx={{bgcolor: "#ff6600"}}>
        ...
        {isXs ? navTitleXS
          ...
          <AppSelect width={"100px"} values={Months} defaultValueIndex={currentMonthIndex} handleChange={handleChange}/>
